...
_G.packer_plugins = {
  ["everforest-nvim"] = {
    loaded = true,
    path = "/home/sky/.local/share/nvim/site/pack/packer/start/everforest-nvim",
  ...
  ["nvim-web-devicons"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/sky/.local/share/nvim/site/pack/packer/opt/nvim-web-devicons",
  ...
  ["vim-tmux-navigator"] = {
    loaded = true,
    path = "/home/sky/.local/share/nvim/site/pack/packer/start/vim-tmux-navigator",
